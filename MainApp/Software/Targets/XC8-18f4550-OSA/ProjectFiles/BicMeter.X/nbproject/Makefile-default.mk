...
SOURCEFILES_QUOTED_IF_SPACED=../../../../Common/App/APP.c ../../../../Common/Driver/BCDdisplay/BCDdisplay.c ../../../../Common/Driver/Key/Key.c ../../../../Common/Driver/SpeedCalc/SpeedCalc.c ../../../../Common/Interrupts/AppInterrupts.c ../../../../OS/OS_manage/OS_manage.c ../../../../OS/Scheduler/Scheduler.c ../../HWIsource/HWI_DIGITAL.c ../../HWIsource/HWI_Interrupts.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2107172035/APP.p1 ${OBJECTDIR}/_ext/1293405090/BCDdisplay.p1 ${OBJECTDIR}/_ext/254734140/Key.p1 ${OBJECTDIR}/_ext/1958996569/SpeedCalc.p1 ${OBJECTDIR}/_ext/1925265964/AppInterrupts.p1 ${OBJECTDIR}/_ext/67042549/OS_manage.p1 ${OBJECTDIR}/_ext/1581091472/Scheduler.p1 ${OBJECTDIR}/_ext/1657922581/HWI_DIGITAL.p1 ${OBJECTDIR}/_ext/1657922581/HWI_Interrupts.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/2107172035/APP.p1.d ${OBJECTDIR}/_ext/1293405090/BCDdisplay.p1.d ${OBJECTDIR}/_ext/254734140/Key.p1.d ${OBJECTDIR}/_ext/1958996569/SpeedCalc.p1.d ${OBJECTDIR}/_ext/1925265964/AppInterrupts.p1.d ${OBJECTDIR}/_ext/67042549/OS_manage.p1.d ${OBJECTDIR}/_ext/1581091472/Scheduler.p1.d ${OBJECTDIR}/_ext/1657922581/HWI_DIGITAL.p1.d ${OBJECTDIR}/_ext/1657922581/HWI_Interrupts.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/2107172035/APP.p1 ${OBJECTDIR}/_ext/1293405090/BCDdisplay.p1 ${OBJECTDIR}/_ext/254734140/Key.p1 ${OBJECTDIR}/_ext/1958996569/SpeedCalc.p1 ${OBJECTDIR}/_ext/1925265964/AppInterrupts.p1 ${OBJECTDIR}/_ext/67042549/OS_manage.p1 ${OBJECTDIR}/_ext/1581091472/Scheduler.p1 ${OBJECTDIR}/_ext/1657922581/HWI_DIGITAL.p1 ${OBJECTDIR}/_ext/1657922581/HWI_Interrupts.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=../../../../Common/App/APP.c ../../../../Common/Driver/BCDdisplay/BCDdisplay.c ../../../../Common/Driver/Key/Key.c ../../../../Common/Driver/SpeedCalc/SpeedCalc.c ../../../../Common/Interrupts/AppInterrupts.c ../../../../OS/OS_manage/OS_manage.c ../../../../OS/Scheduler/Scheduler.c ../../HWIsource/HWI_DIGITAL.c ../../HWIsource/HWI_Interrupts.c main.c
...
${OBJECTDIR}/_ext/2107172035/APP.p1: ../../../../Common/App/APP.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 -I"../../../../" -I"../../../../Common/Link" -I"../../../../Common/Interrupts" -I"../../../../Common/App" -I"../../../../Common/HWIheader" -I"../../../../OS/Scheduler" -I"../../../../Common/Driver" -I"../../../../Common/Driver/SpeedCalc" -I"../../HWIsource" -I"../../../../Common/Driver/BCDdisplay" -I"../../../../Common/Driver/Key" -I"../../../../OS/OS_manage" --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/2107172035/APP.p1  ../../../../Common/App/APP.c 
