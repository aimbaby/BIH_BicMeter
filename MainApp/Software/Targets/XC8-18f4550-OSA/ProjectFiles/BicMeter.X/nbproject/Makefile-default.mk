...
${OBJECTDIR}/_ext/2107172035/APP.p1: ../../../../Common/App/APP.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 -I"../../../../" -I"../../../../Common/Link" -I"../../../../Common/Interrupts" -I"../../../../Common/App" -I"../../../../Common/HWIheader" -I"../../../../OS/Scheduler" -I"../../../../Common/Driver" -I"../../../../Common/Driver/SpeedCalc" -I"../../HWIsource" -I"../../../../Common/Driver/BCDdisplay" -I"../../../../Common/Driver/Key" -I"../../../../OS/OS_manage" -I"../../HWIeeprom" -I"../../../../Common/Driver/EEPROM" -I"../../../../Common/Driver/Buzzer" --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/2107172035/APP.p1  ../../../../Common/App/APP.c 
